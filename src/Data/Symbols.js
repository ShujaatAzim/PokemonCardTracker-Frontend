...
export const raritySymbols = {
  ...
  holo: (
    <img
      src='https://archives.bulbagarden.net/media/upload/6/65/Rarity_Rare_Holo.png'
      alt='holo symbol'
    />
  ),
  rare: (
    <img
      src='https://archives.bulbagarden.net/media/upload/b/b9/Rarity_Rare.png'
      alt='rare symbol'
    />
  ),
  uncommon: (
    <img
      src='https://archives.bulbagarden.net/media/upload/0/0f/Rarity_Uncommon.png'
      alt='uncommon symbol'
    />
  ),
  common: (
    <img
      src='https://archives.bulbagarden.net/media/upload/8/8c/Rarity_Common.png'
      alt='common symbol'
    />
  ),
};
